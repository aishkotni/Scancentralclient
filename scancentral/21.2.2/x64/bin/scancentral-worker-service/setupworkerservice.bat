...
echo ****************************************************************
echo (C) Copyright 2004-2021 Micro Focus or one of its affiliates.
...
set WORKDIR=C:\ScancentralWorkdir
...
--Jvm="%JHOME%\bin\server\jvm.dll"  --JavaHome="%JHOME%"  ++Environment="JAVA_HOME=%JHOME%" --Classpath="%SCA_INSTALL_DIR%\Core\lib\scancentral-launcher-21.1.3.0002.jar"  --Startup=auto  ^
--StartMode=jvm --StartClass=com.fortify.scancentral.launcher.Launcher --StartParams=worker  ^
